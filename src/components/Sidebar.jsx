...
export default function Sidebar() {
  return (
    <aside className="md:sticky md:top-6 md:self-start bg-white p-6 rounded-2xl shadow-md flex flex-col items-center text-center gap-3 md:w-[280px]">
      ...
      {/* Nombre y rol */}
      <h2 className="text-2xl text-black font-semibold">Damián Costa Blanco</h2>
    ...
    <nav className="flex flex-col w-full gap-2 mt-2">
      ...
      <div className="flex gap-4 mt-4 text-gray-700">
        ...
        <a href="https://github.com/Damiancb97" aria-label="GitHub" title="GitHub" className="hover:text-indigo-600">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
