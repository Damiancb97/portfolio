...
export default function Sidebar() {
  ...
  return (
    <aside className="md:sticky md:top-6 md:self-start bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md flex flex-col items-center text-center gap-3 md:w-[280px] transition-colors duration-200">
      {/* Avatar */}
      <img
        src={avatar}
        alt="Avatar"
      ...
      {/* Nombre y rol */}
      <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Damián Costa Blanco</h2>
      <p className="text-gray-500 dark:text-gray-400">{tr.sidebar.role}</p>

      {/* Información de contacto */}
      <div className="w-full text-left text-sm text-gray-700 dark:text-gray-300 border-t border-gray-100 dark:border-gray-700 pt-3">
        <p><strong>{tr.sidebar.email}:</strong> damiancb97@gmail.com</p>
        <p><strong>{tr.sidebar.location}:</strong> {tr.sidebar.locationValue}</p>
      </div>
      ...
      <div className="flex gap-4 mt-4 text-gray-700 dark:text-gray-300">
        <a href="https://www.linkedin.com/in/damiancb" aria-label="LinkedIn" title="LinkedIn" className="hover:text-indigo-500 transition-colors">
        ...
        <a href="https://github.com/Damiancb97" aria-label="GitHub" title="GitHub" className="hover:text-indigo-500 transition-colors">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="mailto:damiancb97@gmail.com" aria-label="Gmail" title="Gmail" className="hover:text-indigo-500 transition-colors">
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
