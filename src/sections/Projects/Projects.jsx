      ...
      <div className="w-full max-w-none px-6">
        ...
        <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(30%,1fr))]">
          ...
          <article className="p-6 bg-gray-50 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold mb-2 text-black">Project A</h3>
            ...
            <a href="#" className="mt-4 inline-block text-blue-600 hover:underline">Show more</a>
          </article>

          <article className="p-6 bg-gray-50 rounded-lg shadow-sm">
            <h3 className="text-xl font-semibold mb-2 text-black">Project B</h3>
