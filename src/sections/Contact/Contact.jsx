      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <a
            ...
            aria-label="Gmail"
            title="Enviar email"
            className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-700 text-[#EA4335] ring-1 ring-gray-200 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
